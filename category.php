            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2><?php echo esc_html('Blog / Category: ', 'credit') ?><?php wp_title( '' ); ?> </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo esc_url( home_url('/') ) ?>"><?php esc_html_e('Home', 'credit') ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo esc_url( home_url('/blog') ) ?>"><?php esc_html_e('Blog', 'credit') ?></a> <?php esc_html_e('/ Category', 'credit') ?> <?php wp_title( '' ); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
