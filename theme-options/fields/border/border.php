  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'credit' ),
        'right_placeholder'  => esc_html__( 'right', 'credit' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'credit' ),
        'left_placeholder'   => esc_html__( 'left', 'credit' ),
        'all_placeholder'    => esc_html__( 'all', 'credit' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'credit' ),
        'dashed'    => esc_html__( 'Dashed', 'credit' ),
        'dotted'    => esc_html__( 'Dotted', 'credit' ),
        'double'    => esc_html__( 'Double', 'credit' ),
        'inset'     => esc_html__( 'Inset', 'credit' ),
        'outset'    => esc_html__( 'Outset', 'credit' ),
        'groove'    => esc_html__( 'Groove', 'credit' ),
        'ridge'     => esc_html__( 'ridge', 'credit' ),
