...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'credit' ),
        'hover'    => esc_html__( 'Hover', 'credit' ),
        'active'   => esc_html__( 'Active', 'credit' ),
        'visited'  => esc_html__( 'Visited', 'credit' ),
        'focus'    => esc_html__( 'Focus', 'credit' )
      );
